...
namespace FusionIntermediateServerHelper
{
    internal partial class Main
    {
        public static class Prefs
        {
            ...
            public static MelonPreferences_Entry<bool> DisableDevToolsCleanup;
            ...
            public static void RefreshMelonPrefs()
            {
                ...
                DisableDevToolsCleanup = GlobalCategory.GetEntry<bool>("Disable DevTools Cleanup") ?? GlobalCategory.CreateEntry("Disable DevTools Cleanup", false);
